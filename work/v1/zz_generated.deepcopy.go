...
func (in *CreatedManifestResourceMeta) DeepCopyInto(out *CreatedManifestResourceMeta) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CreatedManifestResourceMeta.
func (in *CreatedManifestResourceMeta) DeepCopy() *CreatedManifestResourceMeta {
	if in == nil {
		return nil
	}
	out := new(CreatedManifestResourceMeta)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManifestWorkStatus) DeepCopyInto(out *ManifestWorkStatus) {
	*out = *in
	...
	if in.CreatedResources != nil {
		...
		*out = make([]CreatedManifestResourceMeta, len(*in))
		copy(*out, *in)
	}
	return
}
