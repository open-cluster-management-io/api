...
const (
	// WorkProgressing represents that the work is in progress to be
...
const (
	// ManifestProgressing represents the resource that is being applied on the managed cluster.
...
// AppliedManifestWork represents an applied manifestwork that is placed
...
type AppliedManifestWorkSpec struct {
	...
	// ManifestWorkName represents the name of the related manifestwork on a hub.
	// +required
...
type AppliedManifestWorkStatus struct {
	...
	// Only resources with valid GroupVersionResource, namespace, and name are valid.
