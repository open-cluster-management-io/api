...
var map_RegistrationDriverHub = map[string]string{
	...
	"identities":    "For csr authentication type, Identities represent a list of approved users For awsirsa authentication type, Identities represent a list of approved arn patterns",
}
