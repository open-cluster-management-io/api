...
var map_DeployOption = map[string]string{
	...
	"registrationAPIServiceTargetPort": "RegistrationAPIServiceTargetPort will be used in rendering the the file \"cluster-manager-registration-webhook-apiservice.yaml\" in manifests. The default value is 443.",
	"workAPIServiceTargetPort":         "WorkAPIServiceTargetPort also used in rendering the file \"cluster-manager-work-webhook-apiservice.yaml\" in manifests. The default value is 443.",
}
