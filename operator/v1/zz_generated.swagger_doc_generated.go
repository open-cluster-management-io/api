...
var map_AuthDriver = map[string]string{
	"authType":      "Type of the authentication used by hub to initialize the Hub cluster. Possible values are csr and awsirsa.",
	"hubClusterArn": "This represents the hub cluster ARN",
}

func (AuthDriver) SwaggerDoc() map[string]string {
	return map_AuthDriver
}
...
var map_RegistrationHubConfiguration = map[string]string{
	...
	"authDrivers":      "AuthDrivers represent the list of authentication drivers for registration An AuthDriver helps to specify the type of authentication to be supported by the hub",
}
