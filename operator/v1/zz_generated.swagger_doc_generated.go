...
var map_ImporterConfiguration = map[string]string{
	"agentImage":      "AgentImage is the image of the klusterlet agent. If it is not set, the default image will be used with the corresponding version.",
	"hubAPIServerURL": "HubAPIServer is the apiserver endpoint of the hub cluster.",
}

func (ImporterConfiguration) SwaggerDoc() map[string]string {
	return map_ImporterConfiguration
}
...
var map_RegistrationHubConfiguration = map[string]string{
	...
	"importerConfiguration": "ImporterConfiguration is the configuration to import managed clusters from the hub cluster. It applies only when feature gate ClusterImporter is enabled.",
}
