...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ApprovedIdentities) DeepCopyInto(out *ApprovedIdentities) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApprovedIdentities.
func (in *ApprovedIdentities) DeepCopy() *ApprovedIdentities {
	if in == nil {
		return nil
	}
	out := new(ApprovedIdentities)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RegistrationHubConfiguration) DeepCopyInto(out *RegistrationHubConfiguration) {
	*out = *in
	...
	if in.AutoApprovalIdentities != nil {
		in, out := &in.AutoApprovalIdentities, &out.AutoApprovalIdentities
		*out = make([]ApprovedIdentities, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
