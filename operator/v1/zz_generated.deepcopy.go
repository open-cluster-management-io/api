...
func (in *KlusterletSpec) DeepCopyInto(out *KlusterletSpec) {
	*out = *in
	...
	if in.WorkConfiguration != nil {
		in, out := &in.WorkConfiguration, &out.WorkConfiguration
		*out = new(KlusterletWorkConfiguration)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KlusterletWorkConfiguration) DeepCopyInto(out *KlusterletWorkConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KlusterletWorkConfiguration.
func (in *KlusterletWorkConfiguration) DeepCopy() *KlusterletWorkConfiguration {
	if in == nil {
		return nil
	}
	out := new(KlusterletWorkConfiguration)
