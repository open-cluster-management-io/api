...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AuthDriver) DeepCopyInto(out *AuthDriver) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthDriver.
func (in *AuthDriver) DeepCopy() *AuthDriver {
	if in == nil {
		return nil
	}
	out := new(AuthDriver)
...
func (in *RegistrationHubConfiguration) DeepCopyInto(out *RegistrationHubConfiguration) {
	*out = *in
	...
	if in.AuthDrivers != nil {
		in, out := &in.AuthDrivers, &out.AuthDrivers
		*out = make([]AuthDriver, len(*in))
		copy(*out, *in)
	}
	return
}
