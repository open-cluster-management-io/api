...
func (in *RegistrationConfig) DeepCopyInto(out *RegistrationConfig) {
	*out = *in
	...
	if in.CertificateStatus != nil {
		...
		*out = new(RegistrationConfigCertificateStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RegistrationConfigCertificateStatus) DeepCopyInto(out *RegistrationConfigCertificateStatus) {
	*out = *in
	in.LastRenewedTimestamp.DeepCopyInto(&out.LastRenewedTimestamp)
	in.ExpiringTimestamp.DeepCopyInto(&out.ExpiringTimestamp)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegistrationConfigCertificateStatus.
func (in *RegistrationConfigCertificateStatus) DeepCopy() *RegistrationConfigCertificateStatus {
	if in == nil {
		return nil
	}
	out := new(RegistrationConfigCertificateStatus)
