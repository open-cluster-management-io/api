...
type clusterManagementAddOnLister struct {
	listers.ResourceIndexer[*v1alpha1.ClusterManagementAddOn]
}
...
func NewClusterManagementAddOnLister(indexer cache.Indexer) ClusterManagementAddOnLister {
	return &clusterManagementAddOnLister{listers.New[*v1alpha1.ClusterManagementAddOn](indexer, v1alpha1.Resource("clustermanagementaddon"))}
}
