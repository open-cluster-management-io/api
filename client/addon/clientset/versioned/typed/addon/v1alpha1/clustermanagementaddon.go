...
type clusterManagementAddOns struct {
	*gentype.ClientWithList[*v1alpha1.ClusterManagementAddOn, *v1alpha1.ClusterManagementAddOnList]
}
...
func newClusterManagementAddOns(c *AddonV1alpha1Client) *clusterManagementAddOns {
	return &clusterManagementAddOns{
		gentype.NewClientWithList[*v1alpha1.ClusterManagementAddOn, *v1alpha1.ClusterManagementAddOnList](
