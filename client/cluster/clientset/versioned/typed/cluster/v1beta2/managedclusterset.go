...
type managedClusterSets struct {
	*gentype.ClientWithList[*v1beta2.ManagedClusterSet, *v1beta2.ManagedClusterSetList]
}
...
func newManagedClusterSets(c *ClusterV1beta2Client) *managedClusterSets {
	return &managedClusterSets{
		gentype.NewClientWithList[*v1beta2.ManagedClusterSet, *v1beta2.ManagedClusterSetList](
			"managedclustersets",
			c.RESTClient(),
