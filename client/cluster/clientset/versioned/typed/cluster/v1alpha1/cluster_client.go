...
type ClusterV1alpha1Interface interface {
	...
	ManagedClusterClaimsGetter
	MirroredManagedClustersGetter
}
...
func (c *ClusterV1alpha1Client) ManagedClusterClaims(namespace string) ManagedClusterClaimInterface {
	return newManagedClusterClaims(c, namespace)
}

func (c *ClusterV1alpha1Client) MirroredManagedClusters(namespace string) MirroredManagedClusterInterface {
	return newMirroredManagedClusters(c, namespace)
}
