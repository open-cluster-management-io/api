...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("managedclusterclaims"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cluster().V1alpha1().ManagedClusterClaims().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("mirroredmanagedclusters"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cluster().V1alpha1().MirroredManagedClusters().Informer()}, nil
