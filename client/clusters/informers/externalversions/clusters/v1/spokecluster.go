...
import (
	...
	versioned "github.com/open-cluster-management/api/client/clusters/clientset/versioned"
	internalinterfaces "github.com/open-cluster-management/api/client/clusters/informers/externalversions/internalinterfaces"
	v1 "github.com/open-cluster-management/api/client/clusters/listers/clusters/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ClustersV1().SpokeClusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ClustersV1().SpokeClusters().Watch(context.TODO(), options)
			},
		},
		&clustersv1.SpokeCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *spokeClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clustersv1.SpokeCluster{}, f.defaultInformer)
}
