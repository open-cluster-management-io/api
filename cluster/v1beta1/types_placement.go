...
type GroupStrategy struct {
	...
	// The predefined decisionGroups is expected to be a subset of the selected the clusters and the number of items in each group is usually less that number defined in ClustersPerDecisionGroup.
	// Once the number of items exceeds the ClustersPerDecisionGroup, the decisionGroups will also be be divided into multiple decisionGroups with same
	// GroupName but different GroupIndex based on ClustersPerDecisionGroup.
	//
	// +kubebuilder:validation:Required
